...
// Note: La fonction addH1TitleToMarkdownFiles a été supprimée car VitePress injecte déjà automatiquement
// le titre du frontmatter en H1 lors du rendu via le plugin dans config.js
...
// Corriger les chemins d'images relatifs dans tous les fichiers markdown
const fixedImageFiles = fixAllImagePaths(fichiers);

console.log(`✨ ${fixedImageFiles} fichiers ont été corrigés pour les chemins d'images.`);
